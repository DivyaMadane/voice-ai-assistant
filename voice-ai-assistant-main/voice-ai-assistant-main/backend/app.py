        ...
        try:
            if intent == 'check_balance':
                ...
                if result['success']:
                    ...
                    if transactions:
                        template = get_response_template('transactions', detected_lang)
                        if template:
                        ...
                        template = get_response_template('no_transactions', detected_lang)
                ...
                kb_response = get_knowledge_response(intent)
